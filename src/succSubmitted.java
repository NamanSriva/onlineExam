 ...
 * @author naman
 */
public class succSubmitted extends javax.swing.JFrame {

    /**
     * Creates new form succSubmitted
     */
    public succSubmitted() {
        initComponents();
    }
     public succSubmitted(String marks) {
        initComponents();
        String marks1=marks;
    ...
    private void initComponents() {
        ...
        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 50)); // NOI18N
        jLabel6.setText("10");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(succSubmitted.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new succSubmitted().setVisible(true);
            }
        });
    }
